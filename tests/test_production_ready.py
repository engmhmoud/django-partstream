...
class TestProgressiveView(APITestCase):
    ...
    def test_error_handling(self):
        ...
        class TestView(ProgressiveView):
            def get_parts(self):
                return [("good", {"data": "ok"}), ("bad", lazy(self.failing_operation))]
            ...
            def get_parts(self):
                return [
                    (
                        ...
                        lazy(
                            safe_call(
                                self.risky_operation, fallback={"error": "fallback"}
                            )
                        ),
                    )
                ]
    ...
    def test_cached_for_decorator(self):
        ...
        class TestView(ProgressiveView):
            ...
            def get_parts(self):
                return [("cached", lazy(self.get_cached_data))]
...
class TestEdgeCases(TestCase):
    ...
    def test_empty_lazy_function(self):
        ...
        class TestView(ProgressiveView):
            def get_parts(self):
                return [("empty", lazy(self.empty_function))]
